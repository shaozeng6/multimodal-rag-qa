...
> 演示所用文档为 [demo_docs/](demo_docs/) 下的**虚构样例**("云杉 SS-350 智能手冲咖啡机"说明书 + 售后服务手册),品牌、电话、地址等均为杜撰,可安全用于公开展示。完整演示提问建议见 [demo_docs/README.md](demo_docs/README.md)。

**多模态问答** —— 上传产品结构图提问"图中标注的 3 号部件是什么、如何清洁",系统识别图中部件并结合知识库回答,展示引用证据、置信度与执行链路:

![多模态问答](docs/screenshots/chat-multimodal.png)

**文本问答** —— 冲煮模式参数表格化回答,带引用与执行链路:

![文本问答](docs/screenshots/chat-text.png)

**知识库管理** —— 文档列表、chunk/图片/字符统计:
